...
?>
<a name="db_search"></a>
<form id="db_search_form"<?php echo($GLOBALS['cfg']['AjaxEnable'] ? ' class="ajax"' : ''); ?> method="post"
      action="db_search.php" name="db_search">
    ...
    <fieldset>
        ...
        <table class="formlayout">
            <tr>
                <td><?php echo __('Word(s) or value(s) to search for (wildcard: "%"):'); ?></td>
