    ...
    <table id="versions" class="data">
        ...
        while ($one_result = PMA_DBI_fetch_array($all_tables_result)) {
            ...
            <tr class="noclick <?php echo $style; ?>">
                ...
                <td><a <?php echo($GLOBALS['cfg']['AjaxEnable'] ? 'class="drop_tracking_anchor"' : ''); ?>
                ...
                <td><a href="<?php echo $tmp_link; ?>"><?php echo __('Versions'); ?></a>
                    ...
                    | <a
                        href="<?php echo $tmp_link; ?>&amp;snapshot=true&amp;version=<?php echo $version_data['version']; ?>"><?php echo __('Structure snapshot'); ?></a>
                </td>
            </tr>
            <?php
            if ($style == 'even') {
