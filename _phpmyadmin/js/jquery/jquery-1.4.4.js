(function (E, B) {
    ...
    c.extend({
        attrFn: {
            val: true, css: true, html: true, text: true,
            data: true, width: true, height: true, offset: true
    ...
    if (!c.support.changeBubbles) {
        var V, xa = function (a) {
            ...
            if (b === "radio" || b === "checkbox")d = a.checked; else if (b === "select-multiple")d =
        ...
        var o = k.selectors = {
            ...
            preFilter: {
                CLASS: function (g, i, n, m, p, q) {
                    ...
                    if (g[1] === "not")if ((d.exec(g[3]) ||
                        "").length > 1 || /^\w/.test(g[3]))g[3] = k(g[3], null, null, i); else {
            ...
            filter: {
                PSEUDO: function (g, i, n, m) {
                    ...
                    if (q)return q(g, n, i, m); else if (p === "contains")return (g.textContent ||
                        g.innerText || k.getText([g]) || "").indexOf(i[3]) >= 0; else if (p === "not") {
                        i = i[3];
                        n = 0;
