jQuery.ui || function (b) {
    ...
    b.fn.extend({
        _focus: b.fn.focus, focus: function (c, f) {
...
(function (b) {
    ...
    b.Widget.prototype = {
        widgetName: "widget", widgetEventPrefix: "", options: {disabled: false}, _createWidget: function (f, d) {
...
(function (b) {
    ...
    b.fn.position = function (e) {
        ...
        if (e.of.nodeType === 9) {
            ...
            j = g.width();
            h = g.height();
            l = {top: g.scrollTop(), left: g.scrollLeft()}
        ...
        if (e.at[0] === "right")l.left += j; else if (e.at[0] === "center")l.left +=
            j / 2;
        if (e.at[1] === "bottom")l.top += h; else if (e.at[1] === "center")l.top += h / 2;
        l.left += k[0];
        l.top += k[1];
        return this.each(function () {
            var m = b(this), n = m.outerWidth(), o = m.outerHeight(), p = b.extend({}, l);
            if (e.my[0] === "right")p.left -= n; else if (e.my[0] === "center")p.left -= n / 2;
            if (e.my[1] === "bottom")p.top -= o; else if (e.my[1] === "center")p.top -= o / 2;
            ...
            b.fn.bgiframe &&
            m.bgiframe();
            m.offset(b.extend(p, {using: e.using}))
        })
    };
    b.ui.position = {
        fit: {
    ...
    if (!b.offset.setOffset) {
        b.offset.setOffset = function (e, g) {
            ...
            k = {top: g.top - k.top + j, left: g.left - k.left + h};
...
(function (b) {
    ...
    b.extend(b.ui.draggable, {version: "1.8"});
    b.ui.plugin.add("draggable", "connectToSortable", {
        start: function (c, f) {
            var d = b(this).data("draggable"), a = d.options, e = b.extend({}, f, {item: d.element});
            d.sortables = [];
            ...
            var d = b(this).data("draggable"), a = b.extend({}, f, {item: d.element});
    ...
    b.ui.plugin.add("draggable", "scroll", {
        start: function () {
            ...
            if (f.scrollParent[0] !=
                ...
                if (!d.axis || d.axis != "x")if (f.overflowOffset.top + f.scrollParent[0].offsetHeight - c.pageY < d.scrollSensitivity)f.scrollParent[0].scrollTop = a = f.scrollParent[0].scrollTop + d.scrollSpeed; else if (c.pageY - f.overflowOffset.top < d.scrollSensitivity)f.scrollParent[0].scrollTop = a = f.scrollParent[0].scrollTop - d.scrollSpeed;
                ...
                d.scrollSpeed; else if (c.pageX - f.overflowOffset.left < d.scrollSensitivity)f.scrollParent[0].scrollLeft = a = f.scrollParent[0].scrollLeft - d.scrollSpeed
            } else {
                if (!d.axis || d.axis != "x")if (c.pageY - b(document).scrollTop() < d.scrollSensitivity)a = b(document).scrollTop(b(document).scrollTop() - d.scrollSpeed); else if (b(window).height() - (c.pageY - b(document).scrollTop()) < d.scrollSensitivity)a = b(document).scrollTop(b(document).scrollTop() + d.scrollSpeed);
                if (!d.axis || d.axis != "y")if (c.pageX - b(document).scrollLeft() < d.scrollSensitivity)a =
                    b(document).scrollLeft(b(document).scrollLeft() - d.scrollSpeed); else if (b(window).width() - (c.pageX - b(document).scrollLeft()) < d.scrollSensitivity)a = b(document).scrollLeft(b(document).scrollLeft() + d.scrollSpeed)
            }
            ...
            for (var d = b(this).data("draggable"), a = d.options, e = a.snapTolerance, g = f.offset.left, i = g + d.helperProportions.width, k = f.offset.top, j = k + d.helperProportions.height, h = d.snapElements.length - 1; h >= 0; h--) {
                ...
                if (l - e < g && g < m + e && n - e < k && k < o + e || l - e < g && g < m + e &&
                    ...
                    if (a.snapMode != "inner") {
                        ...
                        if (q)f.position.top = d._convertPositionTo("relative", {top: o, left: 0}).top - d.margins.top;
                    ...
                    if (a.snapMode != "outer") {
                        ...
                        r = Math.abs(l - g) <= e;
                        s = Math.abs(m - i) <= e;
                        if (p)f.position.top = d._convertPositionTo("relative", {top: n, left: 0}).top - d.margins.top;
                    ...
                    if (!d.snapElements[h].snapping && (p || q || r || s || u))d.options.snap.snap && d.options.snap.snap.call(d.element, c, b.extend(d._uiHash(), {snapItem: d.snapElements[h].item}));
                    d.snapElements[h].snapping = p || q || r || s || u
                } else {
                    d.snapElements[h].snapping && d.options.snap.release && d.options.snap.release.call(d.element, c, b.extend(d._uiHash(), {snapItem: d.snapElements[h].item}));
...
(function (b) {
    b.widget("ui.droppable", {
        ...
        _drop: function (c, f) {
            ...
            this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                if (e.options.greedy && !e.options.disabled && e.options.scope == d.options.scope && e.accept.call(e.element[0], d.currentItem || d.element) && b.ui.intersect(d, b.extend(e, {offset: e.element.offset()}), e.options.tolerance)) {
                    a = true;
                    return false
                }
            });
    ...
    b.extend(b.ui.droppable, {version: "1.8"});
...
(function (b) {
    b.widget("ui.resizable", b.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.handles.constructor == String) {
                ...
                for (var g = 0; g < e.length; g++) {
                    ...
                    /sw|se|ne|nw/.test(i) && k.css({zIndex: ++a.zIndex});
        ...
        _mouseCapture: function (d) {
            var a = false, e;
            for (e in this.handles)if (b(this.handles[e])[0] == d.target)a = true;
        ...
        _mouseStop: function (d) {
            ...
            if (this._helper) {
                ...
                g = {width: this.size.width - (g ? 0 : this.sizeDiff.width), height: this.size.height - e};
                ...
                a.animate || this.element.css(b.extend(g, {top: i, left: e}));
        ...
        _updateRatio: function (d) {
            ...
            if (d.height)d.width = e.height * this.aspectRatio; else if (d.width)d.height = e.width / this.aspectRatio;
            if (g == "sw") {
        ...
        _respectSize: function (d) {
            ...
            if ((a = !d.width && !d.height) && !d.left && d.top)d.top = null; else if (a && !d.top && d.left)d.left = null;
            return d
        },
    ...
    b.extend(b.ui.resizable, {version: "1.8"});
    ...
    b.ui.plugin.add("resizable", "animate", {
        stop: function (d) {
            ...
            i = {width: a.size.width - (i ? 0 : a.sizeDiff.width), height: a.size.height - k};
            ...
            k ? {top: j, left: k} : {}), {
                duration: e.animateDuration, easing: e.animateEasing, step: function () {
                    ...
                    g && g.length && b(g[0]).css({width: h.width, height: h.height});
                    a._updateCache(h);
        ...
        start: function () {
            ...
            if (a = e instanceof
                ...
                if (/document/.test(e) || e == document) {
                    ...
                    d.parentData = {element: a, left: e.left, top: e.top, width: j, height: k}
                }
            }
        }, resize: function (d) {
            var a = b(this).data("resizable"), e = a.options, g = a.containerOffset, i = a.position;
            d = a._aspectRatio || d.shiftKey;
            var k = {top: 0, left: 0}, j = a.containerElement;
...
(function (b) {
    b.widget("ui.selectable", b.ui.mouse, {
        ...
        _mouseDrag: function (c) {
            ...
            if (!this.options.disabled) {
                ...
                this.helper.css({left: a, top: e, width: g - a, height: i - e});
                this.selectees.each(function () {
                    var j = b.data(this, "selectable-item");
                    if (!(!j || j.element == f.element[0])) {
                        var h = false;
                        if (d.tolerance == "touch")h = !(j.left > g || j.right < a || j.top > i || j.bottom < e); else if (d.tolerance == "fit")h = j.left > a && j.right < g && j.top > e && j.bottom < i;
                        if (h) {
                            if (j.selected) {
    ...
    b.extend(b.ui.selectable, {version: "1.8"})
})(jQuery);
(function (b) {
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _mouseDrag: function (c) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName !=
                    "HTML") {
                    if (this.overflowOffset.top + this.scrollParent[0].offsetHeight - c.pageY < f.scrollSensitivity)this.scrollParent[0].scrollTop = d = this.scrollParent[0].scrollTop + f.scrollSpeed; else if (c.pageY - this.overflowOffset.top < f.scrollSensitivity)this.scrollParent[0].scrollTop = d = this.scrollParent[0].scrollTop - f.scrollSpeed;
                    if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - c.pageX < f.scrollSensitivity)this.scrollParent[0].scrollLeft = d = this.scrollParent[0].scrollLeft + f.scrollSpeed; else if (c.pageX - this.overflowOffset.left <
                        f.scrollSensitivity)this.scrollParent[0].scrollLeft = d = this.scrollParent[0].scrollLeft - f.scrollSpeed
                } else {
                    if (c.pageY - b(document).scrollTop() < f.scrollSensitivity)d = b(document).scrollTop(b(document).scrollTop() - f.scrollSpeed); else if (b(window).height() - (c.pageY - b(document).scrollTop()) < f.scrollSensitivity)d = b(document).scrollTop(b(document).scrollTop() + f.scrollSpeed);
                    if (c.pageX - b(document).scrollLeft() < f.scrollSensitivity)d = b(document).scrollLeft(b(document).scrollLeft() - f.scrollSpeed); else if (b(window).width() -
        ...
        _refreshItems: function (c) {
            ...
            var f = this.items,
                d = [[b.isFunction(this.options.items) ? this.options.items.call(this.element[0], c, {item: this.currentItem}) : b(this.options.items, this.element), this]], a = this._connectWith();
            if (a)for (var e = a.length - 1; e >= 0; e--)for (var g = b(a[e]), i = g.length - 1; i >= 0; i--) {
                ...
                if (k && k != this && !k.options.disabled) {
                    d.push([b.isFunction(k.options.items) ? k.options.items.call(k.element[0], c, {item: this.currentItem}) : b(k.options.items, k.element), k]);
            ...
            for (e = d.length - 1; e >= 0; e--) {
                ...
                for (g = a.length; i < g; i++) {
                    ...
                    f.push({item: k, instance: c, width: 0, height: 0, left: 0, top: 0})
                }
            }
        },
    ...
    b.extend(b.ui.sortable, {version: "1.8"})
})(jQuery);
(function (b) {
    b.widget("ui.accordion", {
        ...
        destroy: function () {
            ...
            if (g.animated) {
                ...
                d = g.collapsible && a ? {
                    toShow: b([]),
                    toHide: f, complete: k, down: e, autoHeight: g.autoHeight || g.fillSpace
                } : {toShow: c, toHide: f, complete: k, down: e, autoHeight: g.autoHeight || g.fillSpace};
                ...
                if (g.collapsible && a)c.toggle(); else {
                    f.hide();
                    c.show()
                }
                k(true)
            ...
            if (!this.running) {
                f.clearStyle && this.toShow.add(this.toHide).css({height: "", overflow: ""});
                ...
                if (c.toHide.size())if (c.toShow.size()) {
                    ...
                    c.toHide.filter(":hidden").each(c.complete).end().filter(":visible").animate(g, {
                        step: function (j, h) {
                            ...
                            c.toShow.css({overflow: d});
                            c.complete()
                        }
                    })
                } else c.toHide.animate({height: "hide"},
                    c); else c.toShow.animate({height: "show"}, c)
        ...
        options: {minLength: 1, delay: 300}, _create: function () {
            ...
            this.menu = b("<ul></ul>").addClass("ui-autocomplete").appendTo("body", f).menu({
                focus: function (d, a) {
                    ...
                    false !== c._trigger("focus", null, {item: e}) && c.element.val(e.value)
                }, selected: function (d, a) {
                    var e = a.item.data("item.autocomplete");
                    false !== c._trigger("select", d, {item: e}) && c.element.val(e.value);
                    c.close(d);
                    c.previous = c.element.val();
                    c.element[0] !==
            ...
            this.menu.element.show().position({
                ...
                of: this.element, collision: "none"
            });
            c = f.width("").width();
...
(function (b) {
    b.widget("ui.menu", {
        ...
        activate: function (c) {
            ...
            this._trigger("focus", null, {item: c})
        }, deactivate: function () {
            if (this.active) {
            ...
            if (this.hasScroll())if (!this.active || this.first())this.activate(this.element.children(":last")); else {
...
(function (b) {
    b.widget("ui.dialog", {
        options: {
            ...
            f.dialogClass).css({zIndex: f.zIndex}).attr("tabIndex", -1).css("outline", 0).keydown(function (k) {
                if (f.closeOnEscape && k.keyCode && k.keyCode === b.ui.keyCode.ESCAPE) {
                    c.close(k);
                    k.preventDefault()
                }
            }).attr({role: "dialog", "aria-labelledby": a}).mousedown(function (k) {
                c.moveToTop(false, k)
            });
            ...
            function f(g) {
                return {
                    originalPosition: g.originalPosition, originalSize: g.originalSize,
            ...
            this.uiDialog.css({top: 0, left: 0}).position({
                my: f.join(" "), at: f.join(" "), offset: d.join(" "), of: window,
            ...
            f = this.uiDialog.css({height: "auto", width: c.width}).height();
            this.element.css(c.height === "auto" ? {
                minHeight: Math.max(c.minHeight -
                f, 0), height: "auto"
            } : {minHeight: 0, height: Math.max(c.height - f, 0)}).show();
            this.uiDialog.is(":data(resizable)") && this.uiDialog.resizable("option", "minHeight", this._minHeight())
        }
    });
    b.extend(b.ui.dialog, {
        version: "1.8", uuid: 0, maxZ: 0, getTitleId: function (c) {
            c = c.attr("id");
            if (!c) {
                this.uuid += 1;
                c = this.uuid
...
(function (b) {
    b.widget("ui.slider", b.ui.mouse, {
        ...
        _start: function (c, f) {
            var d = {handle: this.handles[f], value: this.value()};
        ...
        _slide: function (c, f, d) {
            if (this.options.values && this.options.values.length) {
                ...
                if (d != this.values(f)) {
                    a = this.values();
                    a[f] = d;
                    c = this._trigger("slide", c, {handle: this.handles[f], value: d, values: a});
                    this.values(f ? 0 : 1);
                    c !== false && this.values(f, d, true)
                }
            } else if (d != this.value()) {
                c =
                    this._trigger("slide", c, {handle: this.handles[f], value: d});
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)this.handles.each(function (k) {
                ...
                if (d.options.range === true)if (d.orientation == "horizontal") {
                    k == 0 && d.range.stop(1, 1)[a ? "animate" : "css"]({left: j + "%"}, f.animate);
                    k == 1 && d.range[a ? "animate" : "css"]({width: j - lastValPercent + "%"}, {
                        queue: false,
                        duration: f.animate
                    })
                } else {
                    k == 0 && d.range.stop(1, 1)[a ? "animate" : "css"]({bottom: j + "%"}, f.animate);
                ...
                c == "min" && this.orientation == "horizontal" && this.range.stop(1, 1)[a ? "animate" : "css"]({width: e + "%"}, f.animate);
                c == "max" && this.orientation == "horizontal" && this.range[a ? "animate" : "css"]({width: 100 - e + "%"}, {
                    queue: false,
                    duration: f.animate
                });
                c == "min" && this.orientation == "vertical" && this.range.stop(1, 1)[a ? "animate" : "css"]({height: e + "%"}, f.animate);
                c == "max" && this.orientation == "vertical" && this.range[a ? "animate" : "css"]({height: 100 - e + "%"}, {
                    queue: false,
                    duration: f.animate
                })
            }
...
(function (b) {
    ...
    b.widget("ui.tabs", {
        options: {
            ...
            return {tab: d, panel: a, index: this.anchors.index(d)}
        }, _cleanup: function () {
            ...
            this.anchors.each(function (o, p) {
                ...
                if (i.test(q))e.panels = e.panels.add(e._sanitizeSelector(q)); else if (q != "#") {
        ...
        select: function (d) {
            ...
            this.abort();
            if (!i || this.element.queue("tabs").length !== 0 && b.data(g, "cache.tabs"))this.element.dequeue("tabs"); else {
    ...
    b.extend(b.ui.tabs, {version: "1.8"});
    b.extend(b.ui.tabs.prototype, {
        rotation: null, rotate: function (d, a) {
...
(function (b) {
    ...
    function f(a, e) {
        b.extend(a,
            e);
        for (var g in e)if (e[g] == null || e[g] == undefined)a[g] = e[g];
        return a
    }

    b.extend(b.ui, {datepicker: {version: "1.8"}});
    ...
    b.extend(c.prototype, {
        ...
        _attachments: function (a, e) {
            ...
            if (g == "button" || g == "both") {
                ...
                "" ? g : b("<img/>").attr({src: k, alt: g, title: g})));
        ...
        _isDisabledDatepicker: function (a) {
            if (!a)return false;
            for (var e = 0; e < this._disabledInputs.length; e++)if (this._disabledInputs[e] == a)return true;
            return false
        },
        _getInst: function (a) {
            try {
        ...
        _getBorders: function (a) {
            var e = function (g) {
                return {thin: 1, medium: 2, thick: 3}[g] || g
            };
        ...
        _selectDate: function (a, e) {
            ...
            if (g.inline)this._updateDatepicker(g); else {
                this._hideDatepicker();
        ...
        parseDate: function (a, e, g) {
            ...
            if (g == -1)g = (new Date).getFullYear(); else if (g < 100)g += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (g <= i ? 0 : -100);
            if (o > -1) {
                m = 1;
                n = o;
                do {
        ...
        _generateMonthYearHeader: function (a, e, g, i, k, j, h, l) {
            ...
            if (j || !m)q += '<span class="ui-datepicker-month">' + h[e] + "</span>"; else {
                h = i && i.getFullYear() == g;
                ...
                a.id + "');\">";
                for (var s = 0; s < 12; s++)if ((!h || s >= i.getMonth()) && (!r || s <= k.getMonth()))q += '<option value="' + s + '"' + (s == e ? ' selected="selected"' : "") + ">" + l[s] + "</option>";
                q += "</select>"
            }
            o || (p += q + (j || !(m && n) ? "&#xa0;" : ""));
            if (j || !n)p += '<span class="ui-datepicker-year">' + g + "</span>"; else {
...
(function (b) {
    ...
    b.extend(b.ui.progressbar, {version: "1.8"})
})(jQuery);
jQuery.effects || function (b) {
    ...
    function f() {
        ...
        } else for (l in j)if (typeof j[l] === "string")h[l] = j[l];
        return h
    }
    ...
    b.fn.extend({
        _addClass: b.fn.addClass, addClass: function (j, h, l, m) {
            return h ? b.effects.animateClass.apply(this, [{add: j}, h, l, m]) : this._addClass(j)
        }, _removeClass: b.fn.removeClass, removeClass: function (j, h, l, m) {
            return h ? b.effects.animateClass.apply(this,
                [{remove: j}, h, l, m]) : this._removeClass(j)
        }, _toggleClass: b.fn.toggleClass, toggleClass: function (j, h, l, m, n) {
            return typeof h == "boolean" || h === undefined ? l ? b.effects.animateClass.apply(this, [h ? {add: j} : {remove: j}, l, m, n]) : this._toggleClass(j, h) : b.effects.animateClass.apply(this, [{toggle: j}, h, l, m])
        }, switchClass: function (j, h, l, m, n) {
            return b.effects.animateClass.apply(this, [{add: h, remove: j}, l, m, n])
        }
    });
    b.extend(b.effects, {
        version: "1.8", save: function (j, h) {
            ...
            if (j.css("position") == "static") {
                ...
                b.extend(h, {position: j.css("position"), zIndex: j.css("z-index")});
    ...
    b.fn.extend({
        effect: function (j) {
            ...
            h = {options: h[1], duration: h[2], callback: h[3]};
            var l = b.effects[j];
            return l && !b.fx.off ? l.call(this, h) : this
        }, _show: b.fn.show, show: function (j) {
            if (!j ||
                typeof j == "number" || b.fx.speeds[j])return this._show.apply(this, arguments); else {
                var h = e.apply(this, arguments);
                h[1].mode = "show";
                return this.effect.apply(this, h)
            }
        }, _hide: b.fn.hide, hide: function (j) {
            if (!j || typeof j == "number" || b.fx.speeds[j])return this._hide.apply(this, arguments); else {
                var h = e.apply(this, arguments);
                h[1].mode = "hide";
                return this.effect.apply(this, h)
            }
        }, __toggle: b.fn.toggle, toggle: function (j) {
    ...
    b.extend(b.easing, {
        def: "easeOutQuad", swing: function (j, h, l, m, n) {
...
(function (b) {
    b.effects.blind = function (c) {
        return this.queue(function () {
            ...
            b.effects.save(f, d);
            f.show();
            var g = b.effects.createWrapper(f).css({overflow: "hidden"}), i = e == "vertical" ? "height" : "width";
...
(function (b) {
    b.effects.bounce = function (c) {
        return this.queue(function () {
            ...
            g = c.options.distance || (j == "top" ? f.outerHeight({margin: true}) / 3 : f.outerWidth({margin: true}) /
            3);
...
(function (b) {
    b.effects.clip = function (c) {
        return this.queue(function () {
            ...
            b.effects.save(f, d);
            f.show();
            var g = b.effects.createWrapper(f).css({overflow: "hidden"});
            g = f[0].tagName == "IMG" ? g : f;
            var i = {size: e == "vertical" ? "height" : "width", position: e == "vertical" ? "top" : "left"};
            e = e == "vertical" ? g.height() : g.width();
            if (a == "show") {
                g.css(i.size, 0);
...
(function (b) {
    b.effects.drop = function (c) {
        return this.queue(function () {
            ...
            e = e == "up" || e == "left" ? "pos" : "neg";
            var i = c.options.distance || (g == "top" ? f.outerHeight({margin: true}) / 2 : f.outerWidth({margin: true}) / 2);
...
(function (b) {
    b.effects.explode = function (c) {
        return this.queue(function () {
            ...
            setTimeout(function () {
                c.options.mode == "show" ? a.css({visibility: "visible"}) : a.css({visibility: "visible"}).hide();
...
(function (b) {
    b.effects.fold = function (c) {
        return this.queue(function () {
            ...
            b.effects.save(f, d);
            f.show();
            var k = b.effects.createWrapper(f).css({overflow: "hidden"}), j = a == "show" != g, h = j ? ["width", "height"] : ["height", "width"];
            j = j ? [k.width(), k.height()] : [k.height(), k.width()];
            var l = /([0-9]+)%/.exec(e);
            if (l)e = parseInt(l[1], 10) / 100 *
            j[a == "hide" ? 0 : 1];
            if (a == "show")k.css(g ? {height: 0, width: e} : {height: e, width: 0});
            g = {};
            l = {};
            g[h[0]] = a == "show" ? j[0] : e;
            l[h[1]] = a == "show" ? j[1] : 0;
...
(function (b) {
    b.effects.highlight = function (c) {
        return this.queue(function () {
            var f = b(this), d = ["backgroundImage", "backgroundColor", "opacity"], a = b.effects.setMode(f, c.options.mode || "show"), e = {backgroundColor: f.css("backgroundColor")};
            if (a == "hide")e.opacity = 0;
            b.effects.save(f, d);
            f.show().css({backgroundImage: "none", backgroundColor: c.options.color || "#ffff99"}).animate(e, {
                queue: false, duration: c.duration, easing: c.options.easing, complete: function () {
                    a == "hide" && f.hide();
                    b.effects.restore(f, d);
...
(function (b) {
    b.effects.puff = function (c) {
        return this.queue(function () {
            ...
            b.extend(c.options, {
                ...
                from: d == "hide" ? g : {height: g.height * e, width: g.width * e}
            });
    ...
    b.effects.scale = function (c) {
        return this.queue(function () {
            ...
            i = {height: f.height(), width: f.width()};
            f.from = c.options.from || (a == "show" ? {height: 0, width: 0} : i);
            e = {y: g != "horizontal" ? e / 100 : 1, x: g != "vertical" ? e / 100 : 1};
            f.to = {height: i.height * e.y, width: i.width * e.x};
            if (c.options.fade) {
                if (a == "show") {
                    f.from.opacity = 0;
                    f.to.opacity = 1
    ...
    b.effects.size = function (c) {
        return this.queue(function () {
            ...
            var o = {
                from: {y: f.from.height / n.height, x: f.from.width / n.width},
                to: {y: f.to.height / n.height, x: f.to.width / n.width}
            };
            if (l == "box" || l == "both") {
                if (o.from.y !=
                    o.to.y) {
            ...
            if (l == "content" || l == "both") {
                ...
                f.find("*[width]").each(function () {
                    ...
                    child.from = {height: p.height * o.from.y, width: p.width * o.from.x};
                    child.to = {height: p.height * o.to.y, width: p.width * o.to.x};
                    if (o.from.y != o.to.y) {
...
(function (b) {
    b.effects.slide = function (c) {
        return this.queue(function () {
            ...
            var g = e == "up" || e == "down" ? "top" : "left";
            e = e == "up" || e == "left" ? "pos" : "neg";
            var i = c.options.distance || (g == "top" ? f.outerHeight({margin: true}) : f.outerWidth({margin: true}));
...
(function (b) {
    b.effects.transfer = function (c) {
        return this.queue(function () {
            ...
            d = {top: a.top, left: a.left, height: d.innerHeight(), width: d.innerWidth()};
            a = f.offset();
