(function (a) {
    ...
    a.extend(a.datepicker.regional[""], {hourText: "Hour", minuteText: "Minute", secondText: "Second"});
    ...
    a.datepicker._selectDate = function (c, b) {
        ...
        if (d.inline)this._updateDatepicker(d); else if (!d.stayOpen)if (e)this._updateDatepicker(d); else {
    ...
    g.prototype = {
        init: function () {
            ...
            this.tpDiv.css({height: c.height(), top: b.top, left: b.left + c.outerWidth() + "px"});
            ...
            var b = this;
            a("#hourSlider").slider({
                orientation: "vertical", range: "min", min: 0,
                max: 23, step: 1, slide: function (d, e) {
            ...
            if (c == "hour") {
                if (this._time24h)a("#" + this._mainDivId + " span.fragAmpm").text(""); else {
                    if (b < 12)a("#" + this._mainDivId + " span.fragAmpm").text("am"); else {
