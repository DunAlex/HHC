        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="auto_layout_internal" id="id_auto_layout_internal"/><label
                        ...
                        if (PMA_StorageEngine::isValid('InnoDB') || PMA_StorageEngine::isValid('PBXT')) {
                            ?>
                            <input type="checkbox" name="auto_layout_foreign" id="id_auto_layout_foreign"/><label
    ...
    <table border="0">
        ...
        private function _displayScratchboardTables($array_sh_page)
        {
            ...
            <form method="post" action="schema_edit.php" name="dragdrop">
                <input type="button" name="dragdrop" value="<?php echo __('Toggle scratchboard'); ?>"
                       onclick="ToggleDragDrop('pdflayout');"/>
