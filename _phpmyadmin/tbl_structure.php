...
<form method="post" action="tbl_structure.php" name="fieldsForm" id="fieldsForm">
    ...
    <table id="tablestructure" class="data">
        ...
        while ($row = PMA_DBI_fetch_assoc($fields_rs)) {
            ...
            $odd_row = !$odd_row; ?>">
                <td align="center">
                    <input type="checkbox" name="selected_fld[]" value="<?php echo htmlspecialchars($row['Field']); ?>"
                ...
                <th nowrap="nowrap"><label
                        for="checkbox_row_<?php echo $rownum; ?>"><?php echo $displayed_field_name; ?></label></th>
                ...
                <?php if (!$tbl_is_view && !$db_is_information_schema) { ?>
                    ...
                    <td align="center" class="drop">
                        <a <?php echo($GLOBALS['cfg']['AjaxEnable'] ? ' class="drop_column_anchor"' : ''); ?>
                    ...
                    <td class="more_opts" id="more_opts<?php echo $rownum; ?>">
                        <?php echo __('More'); ?> <img src="<?php echo $pmaThemeImage . 'more.png'; ?>"
                                                       alt="<?php echo __('Show more actions'); ?>"/>
