...
/* none for Opera 11.10 as
<option>s always have solid white background */
    ...
    */
    ...
    <li class="active"> */
        ...
        */
        ...
        z-index: 1100; /** If this is not kept at a high z-index, the jQueryUI modal dialogs (z-index:1000) might hide
        this */
        text-align: center;
        display: inline;
        left: 0;
